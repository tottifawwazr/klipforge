...
var (
	...
	ErrAuthenticationRequired = &Error{"AUTHENTICATION_REQUIRED", "Authentication is required.", 401}
	...
	ErrForbidden              = &Error{"FORBIDDEN", "You do not have permission to perform this action.", 403}
	ErrRoleNotAllowed         = &Error{"ROLE_NOT_ALLOWED", "Your role is not permitted to perform this action.", 403}
	ErrResourceNotFound       = &Error{"RESOURCE_NOT_FOUND", "The requested resource was not found.", 404}
	ErrOwnershipRequired      = &Error{"RESOURCE_OWNERSHIP_REQUIRED", "Access to this resource requires ownership.", 403}
